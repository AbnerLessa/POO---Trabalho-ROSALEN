    ...
    public static void main(String[] args) {
        ...
        while (true){//colocar o jogo em estrutura de repetição para a pessoa poder jogar denovo
            ...
            while(true){//While da primeira fase
                ...
                int advinhar = InOut.leInt("Tente advinhar o numero de 1 a 100");//aqui começa os chutes
                if(advinhar >= 0 && advinhar < numSort){//caso o numero secreto seja maior, -1 vida
                    InOut.MsgDeInformacao("Oraculo", "Segredo eh MAIOR que o palpite");
                    vidas--;
                }
                else if(advinhar <= 100 && advinhar > numSort){//caso o numero secreto seja menor, -1 vida
                    InOut.MsgDeInformacao("Oraculo", "Segredo eh MENOR que o palpite");
                    vidas--;
                }
                else if(advinhar == numSort){//caso o chute seja certo
            ...
            int escolhaJogo = InOut.leInt( "Fim do Jogo!\nDeseja jogar denovo?\n[all]-Sim\n[1]-Não");
            if(escolhaJogo == 1){//jogo acaba
                break;
            }else{
